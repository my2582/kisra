...
#            if not check:
            ...
            layout.analysis[0].children[3].children = '10/29/2021 4:00:00 PM'
            user.date = '10/29/2021 4:00:00 PM'
    ...
    def show_prediction(select, user_info):
        ...
        try:
            df_comp_pkl = pd.read_pickle('./data/processed/comparison_1101_{}.pkl'.format(user.userid))
