...
class query:
    ...
    def BetweenDate(self, table, dates, user):
        ...
        query = "select * from {0} where userid = %s and to_timestamp(%s, 'mm/dd/yyyy HH:M1:SS AM') BETWEEN to_timestamp(%s, 'mm/dd/yyyy HH:M1:SS AM') - interval %s" \
                "and to_timestamp(%s,  'mm/dd/yyyy HH:M1:SS AM') - interval %s "
